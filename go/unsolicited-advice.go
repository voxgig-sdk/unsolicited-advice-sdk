...
// instead of `sdk.NewUnsolicitedAdviceSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *UnsolicitedAdviceSDK  { return NewUnsolicitedAdviceSDK(nil) }
func Test() *UnsolicitedAdviceSDK { return TestSDK(nil, nil) }
