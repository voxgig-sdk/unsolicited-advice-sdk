...
type AdviceEntity struct {
	name    string
	client  *core.UnsolicitedAdviceSDK
...
func NewAdviceEntity(client *core.UnsolicitedAdviceSDK, entopts map[string]any) *AdviceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdviceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
