...
type UnsolicitedAdviceSDK struct {
	Mode     string
...
func (sdk *UnsolicitedAdviceSDK) OptionsMap() map[string]any {
...
func (sdk *UnsolicitedAdviceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UnsolicitedAdviceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UnsolicitedAdviceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UnsolicitedAdviceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UnsolicitedAdviceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UnsolicitedAdviceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UnsolicitedAdviceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UnsolicitedAdviceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UnsolicitedAdviceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UnsolicitedAdviceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *UnsolicitedAdviceSDK {
	...
	sdk := NewUnsolicitedAdviceSDK(sdkopts)
	sdk.Mode = "test"
