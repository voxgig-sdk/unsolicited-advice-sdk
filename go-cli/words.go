...
func registerSDKWords(r *eng.Registry, client *sdk.UnsolicitedAdviceSDK) {
...
func runOp(client *sdk.UnsolicitedAdviceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
