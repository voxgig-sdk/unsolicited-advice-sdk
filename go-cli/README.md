...
AQL-driven CLI and REPL for the UnsolicitedAdvice SDK. Positional arguments are
...
```sh
go build -o unsolicited-advice-cli ./...
```
...
./unsolicited-advice-cli load 1 advice
./unsolicited-advice-cli load '{id:1}' advice
