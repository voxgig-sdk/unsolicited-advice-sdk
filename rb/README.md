...
The Ruby SDK for the UnsolicitedAdvice API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.UnsolicitedAdvice(nil).load(
  { "id" => "test01" }, nil
)
