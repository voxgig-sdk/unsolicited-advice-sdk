...
#      offline in seeded test mode (UnsolicitedAdviceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UnsolicitedAdvice_sdk.rb")
  SDK_CLASS = "UnsolicitedAdviceSDK"
  ...
  SDK_BASE = "UnsolicitedAdvice_sdk"
