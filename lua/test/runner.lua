...
function runner.env_override(m)
  local live = runner.getenv("UNSOLICITED_ADVICE_TEST_LIVE")
  local override = runner.getenv("UNSOLICITED_ADVICE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UNSOLICITED_ADVICE_TEST_EXPLAIN")
