...
function runner.env_override(m)
  local live = runner.getenv("UNSOLICITEDADVICE_TEST_LIVE")
  local override = runner.getenv("UNSOLICITEDADVICE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UNSOLICITEDADVICE_TEST_EXPLAIN")
