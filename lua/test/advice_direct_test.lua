...
describe("AdviceDirect", function()
  it("should direct-list-advice", function()
    local setup = advice_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-advice", setup.live and "live" or "unit")
