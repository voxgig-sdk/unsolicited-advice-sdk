...
|---|---|---|
| `ts/` | @voxgig-sdk/unsolicited-advice-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/unsolicited-advice-sdk \
      --repository voxgig-sdk/unsolicited-advice-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/unsolicited-advice-sdk` shows it, and
`npm trust revoke @voxgig-sdk/unsolicited-advice-sdk --id=<id>` removes it.
