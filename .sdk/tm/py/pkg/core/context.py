...
from projectname_sdk.core.control import UnsolicitedAdviceControl
...
class UnsolicitedAdviceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = UnsolicitedAdviceControl()
        ...
        if isinstance(sp, UnsolicitedAdviceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UnsolicitedAdviceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UnsolicitedAdviceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return UnsolicitedAdviceOperation({})
    ...
    def make_error(self, code, msg):
        return UnsolicitedAdviceError(code, msg, self)
