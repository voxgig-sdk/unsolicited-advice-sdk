...
class UnsolicitedAdviceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UnsolicitedAdviceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UnsolicitedAdviceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UnsolicitedAdviceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
