...
// UnsolicitedAdvice SDK utility: result_basic

class UnsolicitedAdviceResultBasic
{
    public static function call(UnsolicitedAdviceContext $ctx): ?UnsolicitedAdviceResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof UnsolicitedAdviceError) ? $result->err->msg : (string)$result->err;
