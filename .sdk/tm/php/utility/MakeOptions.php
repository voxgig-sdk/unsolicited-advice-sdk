...
// UnsolicitedAdvice SDK utility: make_options

class UnsolicitedAdviceMakeOptions
{
    ...
    public static function call(UnsolicitedAdviceContext $ctx): array
    {
        ...
        //
        // `UnsolicitedAdviceSchema::optspec()` is built from the model:
        ...
        $optspec = UnsolicitedAdviceSchema::optspec();
