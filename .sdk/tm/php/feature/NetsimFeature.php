...
// UnsolicitedAdvice SDK netsim feature
...
class UnsolicitedAdviceNetsimFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _simulate(UnsolicitedAdviceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UnsolicitedAdviceContext $ctx, array $applied): void
    {
        $client = $this->client;
