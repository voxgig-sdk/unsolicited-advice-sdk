...
// UnsolicitedAdvice SDK rbac feature
...
class UnsolicitedAdviceRbacFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _required(UnsolicitedAdviceContext $ctx): ?string
    {
    ...
    private function _reject(UnsolicitedAdviceContext $ctx, string $required): void
    {
    ...
    private function _track(UnsolicitedAdviceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
