...
// UnsolicitedAdvice SDK audit feature
...
class UnsolicitedAdviceAuditFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _emit(UnsolicitedAdviceContext $ctx, string $outcome): void
    {
