...
// UnsolicitedAdvice SDK metrics feature
...
class UnsolicitedAdviceMetricsFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _record(UnsolicitedAdviceContext $ctx, bool $ok): void
    {
