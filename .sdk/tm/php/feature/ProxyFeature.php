...
// UnsolicitedAdvice SDK proxy feature
...
class UnsolicitedAdviceProxyFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    public function init(UnsolicitedAdviceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UnsolicitedAdviceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
