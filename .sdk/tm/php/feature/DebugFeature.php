...
// UnsolicitedAdvice SDK debug feature
...
class UnsolicitedAdviceDebugFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _finish(UnsolicitedAdviceContext $ctx, bool $ok): void
    {
