...
// UnsolicitedAdvice SDK clienttrack feature
...
class UnsolicitedAdviceClienttrackFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    public function PostConstruct(UnsolicitedAdviceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UnsolicitedAdvice-SDK';
