...
// UnsolicitedAdvice SDK timeout feature
...
class UnsolicitedAdviceTimeoutFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _with_timeout(UnsolicitedAdviceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UnsolicitedAdviceContext $_ctx, float $ms): void
    {
        $client = $this->client;
