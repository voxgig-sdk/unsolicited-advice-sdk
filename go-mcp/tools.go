...
type Args struct {
	Entity string         `json:"entity" jsonschema:"advice"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UnsolicitedAdviceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "unsolicited-advice_list",
		Description: "List records from UnsolicitedAdvice. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "unsolicited-advice_load",
		Description: "Load a single record from UnsolicitedAdvice. " +
...
func runOp(client *sdk.UnsolicitedAdviceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UnsolicitedAdviceSDK, name string) (sdk.UnsolicitedAdviceEntity, error) {
