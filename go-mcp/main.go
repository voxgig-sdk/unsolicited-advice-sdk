// Command UnsolicitedAdvice-mcp is an MCP server exposing the UnsolicitedAdvice
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UnsolicitedAdvice_list  — list records of an entity
//	UnsolicitedAdvice_load  — load a single record of an entity
//
