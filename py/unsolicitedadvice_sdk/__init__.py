...
from unsolicitedadvice_sdk.utility import register

# Load features
from unsolicitedadvice_sdk.feature.base_feature import UnsolicitedAdviceBaseFeature
from unsolicitedadvice_sdk.features import _has_feature, _make_feature
...
class UnsolicitedAdviceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = UnsolicitedAdviceUtility()
        self._utility = utility

        from unsolicitedadvice_sdk.config import shared_config
    ...
    def get_utility(self):
        return UnsolicitedAdviceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UnsolicitedAdviceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Advice(self, data=None) -> "AdviceEntity":
        ...
        from unsolicitedadvice_sdk.entity.advice_entity import AdviceEntity
