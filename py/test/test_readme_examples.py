# UnsolicitedAdvice SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UnsolicitedAdviceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UnsolicitedAdviceSDK(...) and UnsolicitedAdviceSDK.test(...) become
#      UnsolicitedAdviceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "unsolicitedadvice_sdk"
_SDK_CLASS = "UnsolicitedAdviceSDK"
