...
// UnsolicitedAdvice SDK utility type

class UnsolicitedAdviceUtility
{
    ...
    public static function copy(UnsolicitedAdviceUtility $src): UnsolicitedAdviceUtility
    {
        $u = new UnsolicitedAdviceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
