...
class UnsolicitedAdviceTestRunner
{
    ...
    {
        $live = self::getenv('UNSOLICITED_ADVICE_TEST_LIVE');
        $override = self::getenv('UNSOLICITED_ADVICE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('UNSOLICITED_ADVICE_TEST_EXPLAIN');
...
class_alias('UnsolicitedAdviceTestRunner', 'Runner');
class_alias('UnsolicitedAdviceHelpers', 'Helpers');
