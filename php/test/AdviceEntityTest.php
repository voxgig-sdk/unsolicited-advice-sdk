...
class AdviceEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set UNSOLICITEDADVICE_TEST_ADVICE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function advice_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("UNSOLICITEDADVICE_TEST_ADVICE_ENTID");
