...
// UnsolicitedAdvice SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UnsolicitedAdviceSDK::test)
...
{
    private const SDK_CLASS = 'UnsolicitedAdviceSDK';
    ...
    private const SDK_BASE = 'unsolicitedadvice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../unsolicitedadvice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
