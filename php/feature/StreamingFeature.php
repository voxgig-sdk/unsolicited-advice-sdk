...
// UnsolicitedAdvice SDK streaming feature
...
class UnsolicitedAdviceStreamingFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _iterate(UnsolicitedAdviceResult $result): \Generator
    {
    ...
    private function _streamable(UnsolicitedAdviceContext $ctx): bool
    {
