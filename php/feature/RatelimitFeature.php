...
// UnsolicitedAdvice SDK ratelimit feature
...
class UnsolicitedAdviceRatelimitFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _acquire(UnsolicitedAdviceContext $ctx): void
    {
    ...
    private function _track(UnsolicitedAdviceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
