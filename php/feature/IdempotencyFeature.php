...
// UnsolicitedAdvice SDK idempotency feature
...
class UnsolicitedAdviceIdempotencyFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _mutating(UnsolicitedAdviceContext $ctx): bool
    {
