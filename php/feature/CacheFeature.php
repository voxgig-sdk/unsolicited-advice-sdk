...
// UnsolicitedAdvice SDK cache feature
...
class UnsolicitedAdviceCacheFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _through(UnsolicitedAdviceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
