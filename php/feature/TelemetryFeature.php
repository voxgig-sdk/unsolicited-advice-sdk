...
// UnsolicitedAdvice SDK telemetry feature
...
class UnsolicitedAdviceTelemetryFeature extends UnsolicitedAdviceBaseFeature
{
    ...
    private function _close(UnsolicitedAdviceContext $ctx, bool $ok): void
    {
