...
// UnsolicitedAdvice SDK utility: graphql
//
...
class UnsolicitedAdviceGraphql
{
    ...
    // equivalent.
    public static function body(UnsolicitedAdviceContext $ctx): mixed
    {
    ...
    public static function errors(UnsolicitedAdviceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
