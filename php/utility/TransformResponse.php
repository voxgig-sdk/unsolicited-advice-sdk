...
// UnsolicitedAdvice SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UnsolicitedAdviceTransformResponse
{
    public static function call(UnsolicitedAdviceContext $ctx): mixed
    {
        ...
        $transform = UnsolicitedAdviceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
