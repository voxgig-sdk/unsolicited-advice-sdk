...
// UnsolicitedAdvice SDK utility: fetcher

class UnsolicitedAdviceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UnsolicitedAdviceSDK/1.0)';
    ...
    public static function call(UnsolicitedAdviceContext $ctx, string $fullurl, array $fetchdef): array
    {
