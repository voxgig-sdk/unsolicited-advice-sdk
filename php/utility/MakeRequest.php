...
// UnsolicitedAdvice SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UnsolicitedAdviceMakeRequest
{
    public static function call(UnsolicitedAdviceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UnsolicitedAdviceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UnsolicitedAdviceResponse($fetched);
        } else {
