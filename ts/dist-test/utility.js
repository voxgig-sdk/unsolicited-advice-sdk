...
function envOverride(m) {
    if ('TRUE' === process.env.UNSOLICITED_ADVICE_TEST_LIVE ||
        'TRUE' === process.env.UNSOLICITED_ADVICE_TEST_OVERRIDE) {
    ...
    m.UNSOLICITED_ADVICE_TEST_EXPLAIN = process.env.UNSOLICITED_ADVICE_TEST_EXPLAIN || m.UNSOLICITED_ADVICE_TEST_EXPLAIN;
    return m;
}
