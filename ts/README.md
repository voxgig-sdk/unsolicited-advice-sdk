...
The TypeScript SDK for the UnsolicitedAdvice API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new UnsolicitedAdviceSDK({ apikey: '...' })
