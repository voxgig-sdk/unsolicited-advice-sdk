# UnsolicitedAdvice TypeScript SDK



The TypeScript SDK for the UnsolicitedAdvice API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Advice()` — each with a small set of operations (`list`, `load`)
...
```ts
new UnsolicitedAdviceSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| Method | Returns | Description |
| --- | --- | --- |
| `UnsolicitedAdviceSDK.test(testopts?, sdkopts?)` | `UnsolicitedAdviceSDK` | Create a test-mode client. |
...
unsolicited-advice/
├── src/
│   ├── UnsolicitedAdviceSDK.ts        # Main SDK class
